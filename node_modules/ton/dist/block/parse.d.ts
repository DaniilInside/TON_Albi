...
export declare function parseCommonMsgInfoRelaxed(slice: Slice): RawCommonMessageInfoRelaxed;
...
export declare type RawMessageRelaxed = {
    raw: Cell;
    info: RawCommonMessageInfoRelaxed;
    init: RawStateInit | null;
    body: Cell;
};
export declare function parseMessageRelaxed(slice: Slice): RawMessageRelaxed;
